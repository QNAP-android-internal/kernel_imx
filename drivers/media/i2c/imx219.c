				 ...
				 struct v4l2_subdev_format *fmt)
{
	...
	unsigned int bin_h, bin_v, final_bin_factor;
	...
	*format = fmt->format;
	...
	final_bin_factor = min(bin_h, bin_v);

	crop = v4l2_subdev_state_get_crop(state, 0);
	crop->width = format->width * final_bin_factor;
	crop->height = format->height * final_bin_factor;
