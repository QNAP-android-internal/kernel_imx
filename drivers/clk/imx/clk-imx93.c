...
static const struct imx93_clk_root {
	...
	{ IMX93_CLK_MEDIA_LDB,		"media_ldb_root",	0x2380,	VIDEO_SEL, CLK_SET_RATE_PARENT, PLAT_IMX93, },
	{ IMX93_CLK_MEDIA_DISP_PIX,	"media_disp_pix_root",	0x2400,	VIDEO_SEL, CLK_SET_RATE_PARENT, },
